        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Browse THs</h1>
                        <form action ="browsethresult.jsp" method="GET">
                        <p>Please enter your query below.</p>
                        <p>
						<input type ="text" name ="browseTH"> <br>
						<select id="sort" name="sort">
						<option>1 - By price</option>
						<option>2 - By average feedback score</option>
						<option>3 - By average score of trusted user feedback</option>
						</select>
						<input type="submit" value="Browse!" onClick="">
                        </p>
