                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<% 
						    ...
						    if(book.Available(THid, arrival, departure, con.stmt))
							{
						    	try
						      	 {
						  			 String SQL = "INSERT INTO Reservations " +
						                       "VALUES (" + THid + ", '" + arrival + "', '" + departure + "', '" + login +"')";
						      		 con.stmt.executeUpdate(SQL);
						      		 out.println("Reservation successfully made");
						      	 }
						    	
						      	 catch(Exception e)
						      	 {
						      		 out.println("Could not add reservation");
						      	 } 
							}
