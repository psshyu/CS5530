...
<head>
    ...
    <title>Uotel - Add Favorite THs</title>
    ...
    <!-- Sidebar -->
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Add Favorite TH</h1>
                        <form action ="addfavresult.jsp" method="GET">
                        <p>Choose a TH from the drop-down menu to favorite</p>
                        <p>
						...
						<input type="submit" value="Favorite!" onClick="">
                        </p>
